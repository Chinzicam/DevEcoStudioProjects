...
export default {
    ...
    data:{
        toolbar:[
            ...
            {value:'购物车',icon:'购物车a.png',inActiveIcon:'购物车.png',name:'shopping_cart',path:'pages/shopping_cart/shopping_cart'},
            {value:'我的',icon:'我的a.png',inActiveIcon:'我的.png',name:'my',path:'pages/my/my'},
        ]
    },
    changePage(k){
